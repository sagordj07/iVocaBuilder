...
public class TodayListAdapter extends RecyclerView.Adapter<TodayListAdapter.WordViewHolder> implements Filterable {
    ...
    TodayListAdapter(Context context,OnDeleteClickListener listener) {
    ...
    public void onBindViewHolder(WordViewHolder holder, final int position) {
        ...
        if (mWords != null){
            ...
            String date = getFormattedDateString(current.getDate());
            String currentDateTimeString = getFormattedDateString(new Date());
            Log.d("DAte", date + "  WAQFA  " + currentDateTimeString);
