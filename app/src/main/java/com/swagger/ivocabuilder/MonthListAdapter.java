...
public class MonthListAdapter extends RecyclerView.Adapter<MonthListAdapter.WordViewHolder> implements Filterable {
    ...
    MonthListAdapter(Context context,OnDeleteClickListener listener) {
    ...
    public void onBindViewHolder(WordViewHolder holder, final int position) {
        ...
        if (mWords != null){
            ...
            Log.d("TAQ", date + "  WAQFA  " + currentDateTimeString);
